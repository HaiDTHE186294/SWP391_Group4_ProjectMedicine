<%-- 
    Document   : footer
    Created on : Oct 6, 2024, 9:49:25 PM
    Author     : trant
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-4 mb-0 mb-md-4 pb-0 pb-md-2">
                        ...
                        <p class="mt-4 me-xl-5">Great pharmacy for quick and effective solutions, whether you need emergency medication, over-the-counter remedies, or a consultation for health advice.</p>
                    </div><!--end col-->
